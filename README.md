...
popular algorithms and data structures. Many of the information 
was taken from online course (JavaScript Algorithms
...
*☝ Note that this project is work on progress. And it is not final and the sole purposes is for learning and researching
only and it is **not** to be used for production.*

## Useful Information

### References

[▶ JavaScript Algorithms and Data Structures Masterclass on Udemy](https://www.udemy.com/js-algorithms-and-data-structures-masterclass/learn/lecture/11183944#overview)

### Big O Notation

*Big O notation* is used in Computer Science to classify algorithms according to how their performance (
time or space) complexities. On the chart below you may find most common orders of growth of 
algorithms specified in Big O notation.

Source: [Big O Cheat Sheet](http://bigocheatsheet.com/).

Below is the list of some of the most used Big O notations and their performance 
comparisons against different sizes of the input data.
